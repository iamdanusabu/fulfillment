...
export function CompanyLogo({ size = 118 }: CompanyLogoProps) {
  return (
    <View style={{ width: size, height: size }}>
      <Svg width={size} height={size} viewBox="0 0 118 118" fill="none">
        ...
        <Defs>
          <LinearGradient id="paint0_linear_7717_9093" x1="61.1406" y1="51.4873" x2="132.907" y2="51.4873" gradientUnits="userSpaceOnUse">
            <Stop stopColor="#A6D3FF"/>
            <Stop offset="0.295696" stopColor="#7FBDFB"/>
            <Stop offset="1" stopColor="#0077ED"/>
          </LinearGradient>
          <LinearGradient id="paint1_linear_7717_9093" x1="65.4421" y1="13.2074" x2="0.716404" y2="16.728" gradientUnits="userSpaceOnUse">
            <Stop stopColor="#0077ED"/>
            <Stop offset="1" stopColor="#A6D3FF"/>
          </LinearGradient>
          <LinearGradient id="paint2_linear_7717_9093" x1="132.681" y1="36.3466" x2="67.4922" y2="36.3466" gradientUnits="userSpaceOnUse">
            <Stop stopColor="#A6D3FF"/>
            <Stop offset="0.295696" stopColor="#7FBDFB"/>
            <Stop offset="1" stopColor="#0077ED"/>
          </LinearGradient>
          <LinearGradient id="paint3_linear_7717_9093" x1="138.696" y1="90.3413" x2="105.785" y2="90.3413" gradientUnits="userSpaceOnUse">
            <Stop stopColor="#A6D3FF"/>
            <Stop offset="0.295696" stopColor="#7FBDFB"/>
            <Stop offset="1" stopColor="#0077ED"/>
          </LinearGradient>
          <LinearGradient id="paint4_linear_7717_9093" x1="105.785" y1="111.498" x2="138.696" y2="111.498" gradientUnits="userSpaceOnUse">
            <Stop stopColor="#A6D3FF"/>
            <Stop offset="0.295696" stopColor="#7FBDFB"/>
            <Stop offset="1" stopColor="#0077ED"/>
          </LinearGradient>
